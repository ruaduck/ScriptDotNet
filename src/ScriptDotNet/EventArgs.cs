...
namespace ScriptDotNet2
{
    ...
    {
        public ClilocSpeechEventArgs(int senderId, string senderName, string text) //public ClilocSpeechEventArgs(uint senderId, string senderName, uint clilocId, string text)
        {
            SenderId = senderId;
            SenderName = senderName;
            //ClilocId = clilocId;
